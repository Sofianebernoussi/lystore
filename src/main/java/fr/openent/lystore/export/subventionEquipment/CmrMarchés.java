...
public class CmrMarchés extends TabHelper {
    private StructureService structureService;
    private ArrayList<Integer> codes = new ArrayList<>();
    private int arraylength = 5;
    private int lineNumber = 1;

    public CmrMarchés(Workbook workbook, JsonObject instruction) {
        super(workbook, instruction, "ANN. 1 RAPPORT CMR Marchés");
