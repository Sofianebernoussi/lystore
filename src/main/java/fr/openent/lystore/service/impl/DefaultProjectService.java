...
public class DefaultProjectService extends SqlCrudService implements ProjectService {
    ...
    public void getProjects(Handler<Either<String, JsonArray>> handler) {
        String query = "SELECT  project.id, project.name project.description, project.id_title, project.id_grade, project.building, project.stair, project.room, project.site, project.preference " +
