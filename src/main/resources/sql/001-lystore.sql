...
ALTER TABLE lystore.order_client_options
    ADD COLUMN name_opt character varying NOT NULL;

ALTER TABLE lystore.order_client_options
    ADD COLUMN amount_opt integer NOT NULL;

ALTER TABLE lystore.order_client_equipment
    ADD CONSTRAINT "status_values" CHECK (status IN ('WAITING', 'VALID', 'REJECTED') );

ALTER TABLE lystore.order_client_options
    ADD COLUMN required_opt boolean NOT NULL;
